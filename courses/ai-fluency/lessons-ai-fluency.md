...
▶️ [The 4D Framework](https://www.youtube.com/watch?v=W4Ua6XFfX9w)
...
- Which of the 4Ds (Delegation, Description, Discernment, Diligence) do you feel most confident in already? Which might need more development?
	- I feel most confident in discernment, but I am aware there is lots of room to improve.
	- I need more development in all of them.
- What specific skills from the 4D framework would most enhance your work or personal projects?
  - Thinking more about the downstream effects of using AI, including work that will build of my work in the future when I may not be around.

 Notes
 - All content in code blocks may be copy / pasted from the course itself. I have added it here as a reference for purposes of my own retention and future studying.
